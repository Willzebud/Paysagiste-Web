  ...
  return (
    <div id="Offre" className="bg-tertiary pb-20">
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="bg-quinary w-auto md:w-[1000px] lg:w-[1000px] mx-2 md:mx-10 lg:w-auto lg:mx-10 h-auto lg:h-auto shadow-xl flex flex-col items-center justify-center">
